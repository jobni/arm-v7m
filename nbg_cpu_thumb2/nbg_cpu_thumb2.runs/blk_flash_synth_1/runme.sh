...
HD_PWD='C:/Users/nibao/Desktop/vivado/arm-v7m/nbg_cpu_thumb2/nbg_cpu_thumb2.runs/blk_flash_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_flash.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_flash.tcl
