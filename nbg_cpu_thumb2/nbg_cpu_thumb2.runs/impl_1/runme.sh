...
HD_PWD='C:/Users/nibao/Desktop/vivado/nbg_cpu_16/nbg_cpu_16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ProcesserCoreSystem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ProcesserCoreSystem.tcl -notrace
