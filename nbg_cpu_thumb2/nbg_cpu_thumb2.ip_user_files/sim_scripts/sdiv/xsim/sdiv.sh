...
#
# Script generated by Vivado on Fri Apr 11 22:13:25 +0800 2025
...
#
# Usage        : sdiv.sh
#                sdiv.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sdiv.sh [-reset_run]
#                sdiv.sh [-reset_log]
#                sdiv.sh [-help]
#
...
# script info
echo -e "sdiv.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sdiv.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sdiv xil_defaultlib.sdiv xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sdiv -key {Behavioral:sim_1:Functional:sdiv} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sdiv.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sdiv.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sdiv.sh [-help]\n\
Usage: sdiv.sh [-step]\n\
Usage: sdiv.sh [-lib_map_path]\n\
Usage: sdiv.sh [-reset_run]\n\
Usage: sdiv.sh [-reset_log]\n\
Usage: sdiv.sh [-keep_index]\n\
Usage: sdiv.sh [-noclean_files]\n\n\
