...
#                script (type 'blk_flash.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/nibao/Desktop/vivado/arm-v7m/nbg_cpu_thumb2/nbg_cpu_thumb2.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
