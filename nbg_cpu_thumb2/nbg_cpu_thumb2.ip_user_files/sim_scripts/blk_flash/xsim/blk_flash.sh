...
#
# Script generated by Vivado on Fri Apr 03 06:46:44 +0800 2026
# SW Build 6403652 on Thu Mar 19 19:48:24 GMT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : blk_flash.sh
...
#
# Usage        : blk_flash.sh
#                blk_flash.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_flash.sh [-rerun]
#                blk_flash.sh [-reset_run]
#                blk_flash.sh [-clean]
#                blk_flash.sh [-reset_log]
#                blk_flash.sh [-help]
#
...
# script info
echo -e "blk_flash.sh - Script generated by export_simulation (Vivado v2025.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_flash.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_flash xil_defaultlib.blk_flash xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_flash -key {Behavioral:sim_1:Functional:blk_flash} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blk_flash.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blk_flash.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blk_flash.sh [-help]\n\
Usage: blk_flash.sh [-step]\n\
Usage: blk_flash.sh [-lib_map_path]\n\
Usage: blk_flash.sh [-rerun]\n\
Usage: blk_flash.sh [-reset_run]\n\
Usage: blk_flash.sh [-clean]\n\
Usage: blk_flash.sh [-reset_log]\n\
Usage: blk_flash.sh [-keep_index]\n\
Usage: blk_flash.sh [-noclean_files]\n\n\
