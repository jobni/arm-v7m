...
#
# Script generated by Vivado on Sat Nov 01 11:08:41 +0800 2025
...
# script info
echo -e "blk_flash.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_flash xil_defaultlib.blk_flash xil_defaultlib.glbl -log elaborate.log
}
