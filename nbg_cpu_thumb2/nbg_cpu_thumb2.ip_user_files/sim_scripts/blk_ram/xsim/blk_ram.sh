...
#
# Script generated by Vivado on Fri Apr 03 06:46:42 +0800 2026
...
#
# Usage        : blk_ram.sh
#                blk_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_ram.sh [-rerun]
#                blk_ram.sh [-reset_run]
#                blk_ram.sh [-clean]
#                blk_ram.sh [-reset_log]
#                blk_ram.sh [-help]
#
...
# script info
echo -e "blk_ram.sh - Script generated by export_simulation (Vivado v2025.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_ram xil_defaultlib.blk_ram xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blk_ram.wdb xsim.dir libdpi.so)
...
Usage: blk_ram.sh [-step]\n\
Usage: blk_ram.sh [-lib_map_path]\n\
Usage: blk_ram.sh [-rerun]\n\
Usage: blk_ram.sh [-reset_run]\n\
Usage: blk_ram.sh [-clean]\n\
Usage: blk_ram.sh [-reset_log]\n\
Usage: blk_ram.sh [-keep_index]\n\
