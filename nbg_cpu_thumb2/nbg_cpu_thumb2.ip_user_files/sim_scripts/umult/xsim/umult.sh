...
#
# Script generated by Vivado on Fri Apr 11 22:16:30 +0800 2025
...
#
# Usage        : umult.sh
#                umult.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                umult.sh [-reset_run]
#                umult.sh [-reset_log]
#                umult.sh [-help]
#
...
# script info
echo -e "umult.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./umult.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot umult xil_defaultlib.umult xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim umult -key {Behavioral:sim_1:Functional:umult} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb umult.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./umult.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: umult.sh [-help]\n\
Usage: umult.sh [-step]\n\
Usage: umult.sh [-lib_map_path]\n\
Usage: umult.sh [-reset_run]\n\
Usage: umult.sh [-reset_log]\n\
Usage: umult.sh [-keep_index]\n\
Usage: umult.sh [-noclean_files]\n\n\
