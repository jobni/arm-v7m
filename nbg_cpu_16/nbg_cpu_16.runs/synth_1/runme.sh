...
HD_PWD='C:/Users/nibao/Desktop/vivado/nbg_cpu_16/nbg_cpu_16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ProcesserCoreSystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ProcesserCoreSystem.tcl
