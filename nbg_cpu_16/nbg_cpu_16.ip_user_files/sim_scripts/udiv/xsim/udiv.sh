...
#
# Script generated by Vivado on Fri Apr 11 22:14:29 +0800 2025
...
#
# Usage        : udiv.sh
#                udiv.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                udiv.sh [-reset_run]
#                udiv.sh [-reset_log]
#                udiv.sh [-help]
#
...
# script info
echo -e "udiv.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./udiv.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot udiv xil_defaultlib.udiv xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim udiv -key {Behavioral:sim_1:Functional:udiv} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb udiv.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./udiv.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: udiv.sh [-help]\n\
Usage: udiv.sh [-step]\n\
Usage: udiv.sh [-lib_map_path]\n\
Usage: udiv.sh [-reset_run]\n\
Usage: udiv.sh [-reset_log]\n\
Usage: udiv.sh [-keep_index]\n\
Usage: udiv.sh [-noclean_files]\n\n\
