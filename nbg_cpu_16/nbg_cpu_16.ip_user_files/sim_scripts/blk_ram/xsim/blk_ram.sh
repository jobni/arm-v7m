...
#
# Script generated by Vivado on Thu Apr 10 23:26:33 +0800 2025
...
# script info
echo -e "blk_ram.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_ram xil_defaultlib.blk_ram xil_defaultlib.glbl -log elaborate.log
}
